  ...
  <el-container class="all">
    ...
    <el-container>
      ...
      <el-main style="width: 100%; height: 100%">
        ...
        <div class="foot">
          <span style="font-family: Tahoma;color: #f3f3f3;font-size: 14px;line-height: 47px;">版权所有: 中稹融创 电话: 028-85237573 邮箱: zzrc_group@qq.com 地址: 四川省成都市高新区天府四街158号易上OCG国际中心C座6层</span>
        </div>
        <div class="foot2">
